...
public class TestUtils {
	...
	static {
		...
		dynamodbEventMapper.setPropertyNamingStrategy(
				new UpperCaseRecordsPropertyNamingStrategy());
	...
	private static final DateTimeFormatter dateTimeFormatter = ISODateTimeFormat
			.dateTime().withZone(new FixedDateTimeZone("GMT", "GMT", 0, 0));
	...
	private static interface DynamodbEventMixin {
		...
		public static final String AWS_REGION = "US West (Oregon)"; // "awsRegion";
